...
esp_err_t bno055_get_temperature(uint8_t* temperature);
...
esp_err_t bno055_displ_sys_status();
...
esp_err_t bno055_get_calib_status(uint8_t* system, uint8_t* gyro, uint8_t* accel, uint8_t* mag);
